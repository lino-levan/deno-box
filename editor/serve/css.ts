import { extname } from "jsr:@std/path@0.221.0/extname";
...
export function compileCss() {
  ...
  return compile(defaultCss).build(Array.from(candidates));
}

// Blocked on https://github.com/denoland/deno_core/pull/402
const defaultCss = `
@theme {
  /* Defaults */
